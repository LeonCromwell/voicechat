      ...
      (this.config = Object.assign(
        {
          ...
          encoderFrameSize: 20,
          encoderPath:
            "https://symbl-sdk-cdn-bucket.storage.googleapis.com/js/ga/symbl-opus-encdec/0.1.2/dist/encoderWorker.min.js",
  ...
  (Recorder.prototype.close = function () {
    return (
      ...
      this.config.sourceNode.context
        ? (URL.revokeObjectURL(this.encoderWorkerUrl), Promise.resolve())
  ...
  (Recorder.prototype.initEncoder = function () {
    "function" == typeof registerProcessor
      ...
      : ((this.encoderNode = this.audioContext.createScriptProcessor(
        ...
        (this.encoderNode.onaudioprocess = ({ inputBuffer: e }) =>
        ...
        var o = ({ data: i }) => {
          switch (i.message) {
            case "ready":
              ...
              break;
            case "page":
              (this.encodedSamplePosition = i.samplePosition), e(i.page);
              break;
            case "done":
              this.encoder.removeEventListener("message", o), this.finish();
              break;
            default:
              i.page && e(i.page);
          }
    ...
    return "paused" === this.state || "recording" === this.state
      ? ((this.state = "inactive"),
        ...
        new Promise((e) => {
          var t = ({ data: o }) => {
            "done" === o.message &&
              (this.encoder.removeEventListener("message", t), e());
          };
          this.encoder.addEventListener("message", t),
            this.encoder.start && this.encoder.start(),
